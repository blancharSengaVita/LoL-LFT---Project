...
deleteModal: $wire.entangle('deleteModal'),
    ...
    <div x-cloak class="border-b border-gray-200 bg-white px-4 py-5 sm:px-6">
        <div class="flex justify-between gap-x-4 pb-1 items-center sm:flex-nowrap">
            <h3 class="text-base font-semibold leading-6 text-gray-900 ">{{'Anciens membres'}}</h3>
            <div class="flex">
                {{--                <button--}}
                {{--                    wire:click="createSingleModel"--}}
        ...
        <div class=" sm:w-12/12">
            <ul role="list" class="divide-y divide-gray-100">
                @if(count($models)===0 || null)
                    <p class="mt-1 mb-1 flex justify-center text-black">Il n'y a aucun ancien membre dans cette
                        équipe</p>
                @else
                                    ...
                                    <div x-show="$wire.create" class="w-auto">
                                        ...
                                        >
                                            <input
                                                ...
                                                wire:model.live="search" id="player" type="search" class="w-80 rounded-md border-0 bg-white py-1.5 pl-8 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-700 sm:text-sm sm:leading-6" role="combobox" aria-controls="options" aria-expanded="false">
