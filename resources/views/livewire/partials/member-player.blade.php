...
use \App\Jobs\SendInvitationToJoinLoLLFT;
...
$saveSingleModel = function () {
    ...
    SendInvitationToJoinLoLLFT::dispatch($this->email, $this->username, $this->user);
                        ...
                        <div class="sm:flex sm:items-start">
                            <div class="w-full mt-3 text-center sm:mt-0 sm:text-left">
                                    ...
                                    <div x-show="$wire.create" class="w-auto">
                                        ...
                                        >
                                            <input
                                                ...
                                                id="player" type="search" class="w-80 rounded-md border-0 bg-white py-1.5 pl-8 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-700 sm:text-sm sm:leading-6" role="combobox" aria-controls="options" aria-expanded="false">
                                ...
                                <h3 class="text-base font-semibold leading-6 text-gray-900" id="modal-title">
                                    @if($username === '') Ajouter un joueur manuellement @else Modifier un joueur @endif</h3>
                                <div class="mt-4">
                                ...
                                @if($id === 0)
                                    <div class="mt-4">
                                        ...
                                        <div class="mt-2">
                                            <input wire:model="email" type="email" name="email" id="email" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-700 sm:text-sm sm:leading-6" placeholder="jhon@doe">
                                        </div>
                                        <p class="mt-2 text-sm text-gray-500" id="password-description">Le mail nous
                                            servira à envoyer un mail afin que ton coéquipier s'incrivent sur le
                                            site</p>
