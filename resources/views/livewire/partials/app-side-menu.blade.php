            ...
            <ul role="list" class="flex flex-1 flex-col gap-y-7">
                <li>
                    <ul role="list" class="-mx-2 space-y-1">
                        <li>
                            ...
                            <a wire:navigate href="{{route('dashboard')}}" title="Vers la page dashboard"
                               class="{{ Route::is('dashboard') ? 'bg-gray-50 text-indigo-600' : 'text-gray-700 hover:text-indigo-600 hover:bg-gray-50' }} group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold">
                                <svg class="{{ Route::is('dashboard') ? 'text-indigo-600' : 'text-gray-400' }} h-6 w-6 shrink-0  group-hover:text-indigo-600" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
                        ...
                        <li>
                            <a dusk="findTeammateSideMenu" wire:navigate href="{{route('find-teammate')}}" title="Vers la page recherche de partenaires"
                        ...
                        <li>
                            <a dusk="messageSideMenu" wire:navigate href="{{route('messages')}}" title="Vers la page messages" class="{{ Route::is('messages') || Route::is('conversation') ? 'bg-gray-50 text-indigo-600' : 'text-gray-700 hover:text-indigo-600 hover:bg-gray-50' }} group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold items-center">
