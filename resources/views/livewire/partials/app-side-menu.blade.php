                ...
                <li>
                    <ul role="list" class="-mx-2 space-y-1">
                        <li>
                            ...
                            <a href="{{route('dashboard')}}" class="{{ Route::is('dashboard') ? 'bg-gray-50 text-indigo-600' : 'text-gray-700 hover:text-indigo-600 hover:bg-gray-50' }} group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold">
                        ...
                        <li>
                            <a href="{{route('find-teammate')}}" class="{{ Route::is('find-teammate') ? 'bg-gray-50 text-indigo-600' : 'text-gray-700 hover:text-indigo-600 hover:bg-gray-50' }}  group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold">
                        ...
                        <li>
                            <a href="{{route('messages')}}" class="{{ Route::is('messages') ? 'bg-gray-50 text-indigo-600' : 'text-gray-700 hover:text-indigo-600 hover:bg-gray-50' }} group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold">
                        ...
                        <li>
                            <a href="{{route('notifications')}}" class="{{ Route::is('notifications') ? 'bg-gray-50 text-indigo-600' : 'text-gray-700 hover:text-indigo-600 hover:bg-gray-50' }} group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold">
                        ...
                        <li>
                            <a href="{{route('missions')}}" class="{{ Route::is('missions') ? 'bg-gray-50 text-indigo-600' : 'text-gray-700 hover:text-indigo-600 hover:bg-gray-50' }} group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold">
                        ...
                        <li>
                            <a href="{{route('settings')}}" class="{{ Route::is('settings') ? 'bg-gray-50 text-indigo-600' : 'text-gray-700 hover:text-indigo-600 hover:bg-gray-50' }} group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold">
