...
$showHidePassword = function () {
    $this->booleanType = !$this->booleanType;
    if ($this->booleanType) {
        $this->type = 'text';
    } else {
        $this->type = 'password';
        ...
        <div class="bg-white px-6 py-12 shadow sm:rounded-lg sm:px-12">
            <form wire:submit="register" class="space-y-6">
                <div>
                    ...
                    <div class="mt-2">
                        <input wire:model="email" id="email" name="email" type="email" autocomplete="email" required class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-700 sm:text-sm sm:leading-6">
                    </div>
                ...
                <div>
                    ...
                    <div class="mt-2">
                        <input wire:model="password" id="password" name="password" type="{{$type}}" autocomplete="current-password" required class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-700 sm:text-sm sm:leading-6">

                        @if($booleanType)
                            <button class="mt-1 text-sm text-gray-600 underline" type="button" wire:click="showHidePassword">
                    ...
                    <p class="mt-1 text-sm text-gray-500" id="password-description">Le mot de passe doit contenir au
