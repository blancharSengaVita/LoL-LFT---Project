...
{{--                </div>--}}
        ...
        <p class="mt-10 text-center text-sm text-gray-500">
            Pas encore inscrit ?
            <a href="{{ route('register') }}" title="Vers la page d'inscription" wire:navigate class="font-semibold leading-6 text-indigo-600 hover:text-indigo-500">Rejoins-nous</a>
        </p>
    </div>
</div>
