        ...
        <div class="h-full flex flex-row flex-grow justify-between bg-white border-t border-gray-200">
            ...
            <div class="w-full flex flex-col justify-between">
                ...
                <form wire:submit.prevent="submitMessage" class="pb-5 px-3 pt-2 flex">
                    ...
                    />
                    <button dusk="ConversationMessageSending" class="ml-2 text-gray-700 hover:text-indigo-600 hover:bg-gray-50 group flex gap-x-3 rounded-md py-2 text-sm leading-6 font-semibold">
